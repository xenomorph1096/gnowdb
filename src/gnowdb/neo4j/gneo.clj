...
(defn createAttributeType
  ...
  [& {:keys [:_name :_datatype :subTypeOf :subjectQualifier :attributeQualifier :valueQualifier :execute?] :or {:execute? true :subjectQualifier [] :attributeQualifier [] :valueQualifier []} :as keyArgs}]
  {:pre [
         (string? _name)
